...
<head>
  ...
  <title>Bem-vindo ao Sinergia</title>
</head>
          ...
          <tr>
            <td style="background:linear-gradient(160deg,#2a0e0e 0%,#1e1414 60%,#161212 100%);border-radius:20px;padding:48px 40px;text-align:center;">
              ...
              <h1 style="margin:0 0 16px;font-size:26px;line-height:1.3;color:#ffb3ad;font-style:italic;font-weight:400;">
                Os astros já sabem<br/>o seu caminho.
              </h1>
              <p style="margin:0;font-size:15px;line-height:1.7;color:#c9b8b8;font-family:Arial,sans-serif;">
                A partir de agora, cada manhã começa com intenção.<br/>
                Sua previsão diária chega antes do café — escrita<br/>
                especialmente para você e para o seu signo.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="border-top:1px solid #ffb77b20;"></td>
                </tr>
              </table>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="padding:12px 0;border-bottom:1px solid #ffffff08;">
                    <p style="margin:0;font-size:14px;color:#ffb77b;font-style:italic;">♥&nbsp;&nbsp;Amor</p>
                    <p style="margin:4px 0 0;font-size:13px;color:#c9b8b8;font-family:Arial,sans-serif;line-height:1.5;">Como os astros influenciam seus vínculos neste dia.</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 0;border-bottom:1px solid #ffffff08;">
                    <p style="margin:0;font-size:14px;color:#ffb77b;font-style:italic;">⚡&nbsp;&nbsp;Energia</p>
                    <p style="margin:4px 0 0;font-size:13px;color:#c9b8b8;font-family:Arial,sans-serif;line-height:1.5;">Sua vitalidade e disposição sob o mapa celeste.</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 0;">
                    <p style="margin:0;font-size:14px;color:#ffb77b;font-style:italic;">✦&nbsp;&nbsp;Trabalho</p>
                    <p style="margin:4px 0 0;font-size:13px;color:#c9b8b8;font-family:Arial,sans-serif;line-height:1.5;">Onde focar sua atenção e talento hoje.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:0 40px 8px;text-align:center;">
              <p style="margin:0;font-size:11px;color:#ffffff30;font-family:Arial,sans-serif;line-height:1.6;">
                ...
                <a href="https://sinergia-astros.app" style="color:#ffb77b60;text-decoration:none;">sinergia.app</a>
                &nbsp;·&nbsp;
...
export const welcomeEmailSubject = "Os astros já sabem o seu caminho · Sinergia";
